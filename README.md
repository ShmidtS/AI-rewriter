...
Интеллектуальный инструмент для переписывания текстов с использованием Google Gemini API. Приложение позволяет автоматически переписывать большие тексты (книги, статьи) с сохранением смысла, но с улучшенным стилем и структурой.
...
- Поддержка всех моделей Google Gemini
...
3. **Язык** - выберите язык переписывания (Русский/English)
